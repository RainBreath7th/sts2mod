...
| --- | --- | --- | --- | --- |
| `海克斯符文 HextechRunes/本体` | `HextechRunes` | `0.9.3` | `0.107.1` | 海克斯大乱斗（ARAM: Mayhem）：每幕选择海克斯符文、敌人同步获得敌方海克斯的大型玩法拓展，300+ 符文、属性锻造器、新卡牌与联机同步。 |
| `海克斯符文 HextechRunes/拓展包` | `HextechRunesSponsorPack` | `0.9.1` | `0.107.1` | 海克斯大乱斗的额外拓展包，收录风格更独立的赞助者海克斯、附魔与属性锻造器内容。 |
| `集成战略事件 IntegratedStrategyEvents` | `IntegratedStrategyEvents` | `0.5.6` | `0.107.1` | 集成战略风格的事件拓展：先古防线、树洞、秘密节点等大量自定义事件与遭遇；同一模组包兼容游戏 `0.107.1`、`0.110.1` 与 `0.111.0`，需要 RitsuLib `0.5.18`。 |
...
以下模组已停止维护，且未发布到 Steam 创意工坊。源码保留供参考。

These mods are no longer maintained and have not been published on the Steam Workshop. Their source code is retained for reference.

| 目录 | 模组 ID | 最后版本 | 简介 |
| --- | --- | --- | --- |
| [AI队友 AITeammate](<已归档/AI队友 AITeammate/>) | `sts2AITeammate` | `0.1.1` | 加入 AI 多人模式、AI 队友和主机 AI 托管。 |
| [初始牌组调整 StartingDeckTweaks](<已归档/初始牌组调整 StartingDeckTweaks/>) | `StartingDeckTweaks` | `1.0.1` | 调整角色初始牌组。 |
| [第四幕 StS1Act4](<已归档/第四幕 StS1Act4/>) | `StS1Act4` | `0.1.0` | 还原/扩展类似一代第四幕的内容。 |
...
其他已发布的模组请在创意工坊搜索对应英文名，或查看作者主页：https://steamcommunity.com/profiles/76561199076042004/myworkshopfiles/?appid=2868840
